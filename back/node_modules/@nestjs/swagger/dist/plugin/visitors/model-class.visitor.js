...
class ModelClassVisitor extends abstract_visitor_1.AbstractFileVisitor {
    ...
    createTypePropertyAssignments(factory, node, typeChecker, existingProperties, hostFilename, options) {
        ...
        if (node) {
            if (ts.isTypeLiteralNode(node)) {
                const initializer = this.createInitializerForTypeLiteralNode(node, factory, typeChecker, existingProperties, hostFilename);
    ...
    createInitializerForTypeLiteralNode(node, factory, typeChecker, existingProperties, hostFilename) {
