...
export class AdminController {
    ...
    async createFriendship(
        ...
        const friendship = await this.friendService.createFriendRequest(body.initiatorId, body.acceptorId);
        return this.friendService.acceptFriendRequest(body.acceptorId, friendship.id);
    }
}
