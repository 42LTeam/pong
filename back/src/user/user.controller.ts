...
export class UserController {
  ...
  async updateUserAvatar(@Param('id', ParseIntPipe, UserIdValidationPipe) id: number, @Body() updateUserAvatarDto: UpdateUserAvatarDto): Promise<User> {
...
async updateUserName(
  ...
  async getFriendsOfUser(@Param('id', ParseIntPipe, UserIdValidationPipe) id: number): Promise<User[]> {
    return this.userService.getFriendsOfUser(Number(id));
  }

  @Get('friend/online/:id')
  @ApiOperation({ summary: 'Get friend of user' })
  async getOnlineFriendsOfUser(@Param('id', ParseIntPipe, UserIdValidationPipe) id: number): Promise<User[]> {
  ...
  async getPendingFriends(@Param('userId', ParseIntPipe, UserIdValidationPipe) userId: number): Promise<any[]> {
    return this.userService.getPendingFriendRequests(Number(userId));
  }

  @Delete(':id')
  @ApiOperation({ summary: 'Delete user' })
  async deleteUser(@Param('id', ParseIntPipe, UserIdValidationPipe) id: number): Promise<User> {
